...
/*   Updated: 2023/07/20 15:19:33 by acepni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map_errors(t_game *game, int *p_count, int *e_count, int index)
{
	...
	if (game->game_map.map[i][j] != 'P' && game->game_map.map[i][j] != 'C'
		&& game->game_map.map[i][j] != 'E' && game->game_map.map[i][j] != 'Q'
		&& game->game_map.map[i][j] != '1' && game->game_map.map[i][j] != '0')
		ft_error(game, 31);
